...
function QuestionAndAnswer() {
  ...
  // ANSWER ERROR and succsses CONTROLLER
  ...
  async function handle(e) {
    ...
    if (!answerValue) {
      ...
      setErrorMessage("Please provide the answer!");
      setSuccessMessage(""); // Clear success message if any
      return;
    }

    // chacter limit checker
    if (answerValue.length > 200) {
      setErrorMessage("Please! the answer can not exceed 200 characters.");
      setSuccessMessage(""); // Clear success message if any
      return;
    }
    ...
    try {
      ...
      setSuccessMessage("Answer replied successfully! Redirecting...");
